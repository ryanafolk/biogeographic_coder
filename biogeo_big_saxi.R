...
trfn = "ultrametric_occur_matched.nwk"
...
# (from Ree & Smith 2008)
geogfn = "biogeomatrix_7regions_treematched.txt"
...
runslow = FALSE
resfn = "Saxifragales_DEC_May_1_18.Rdata"
if (runslow)
{
...
resfn = "Saxifragales_DEC+J_May_1_18.Rdata"
runslow = FALSE
if (runslow)
{
...
# PDF plots
#######################################################
pdffn = "Saxifragales_DEC_vs_DEC+J_May_1_18.pdf"
pdf(pdffn, width=30, height=90)

#######################################################
# Plot ancestral states - DEC
#######################################################
analysis_titletxt ="BioGeoBEARS DEC on Saxifragales_May_1_18"
...
#######################################################
analysis_titletxt ="BioGeoBEARS DEC+J on Saxifragales_May_1_18"
...
runslow = TRUE
resfn = "Saxifragales_DIVALIKE_May_1_18.Rdata"
if (runslow)
{
  res = bears_optim_run(BioGeoBEARS_run_object)
  res    
...
resfn = "Saxifragales_DIVALIKE+J_May_1_18.Rdata"
runslow = TRUE
if (runslow)
{
  #sourceall("/Dropbox/_njm/__packages/BioGeoBEARS_setup/")
...
pdffn = "Saxifragales_DIVALIKE_vs_DIVALIKE+J_May_1_18.pdf"
pdf(pdffn, width=8, height=12)

#######################################################
# Plot ancestral states - DIVALIKE
#######################################################
analysis_titletxt ="BioGeoBEARS DIVALIKE on Saxifragales_May_1_18"
...
#######################################################
analysis_titletxt ="BioGeoBEARS DIVALIKE+J on Saxifragales_May_1_18"
...
runslow = TRUE
resfn = "Saxifragales_BAYAREALIKE_May_1_18.Rdata"
if (runslow)
{
  res = bears_optim_run(BioGeoBEARS_run_object)
  res    
...
resfn = "Saxifragales_BAYAREALIKE+J_May_1_18.Rdata"
runslow = TRUE
if (runslow)
{
  res = bears_optim_run(BioGeoBEARS_run_object)
...
pdffn = "Saxifragales_BAYAREALIKE_vs_BAYAREALIKE+J_May_1_18.pdf"
pdf(pdffn, width=8, height=12)

#######################################################
# Plot ancestral states - BAYAREALIKE
#######################################################
analysis_titletxt ="BioGeoBEARS BAYAREALIKE on Saxifragales_May_1_18"
...
#######################################################
analysis_titletxt ="BioGeoBEARS BAYAREALIKE+J on Saxifragales_May_1_18"
